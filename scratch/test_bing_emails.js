...
async function run() {
  const queries = [
    `"gmail.com" "ξενοδοχεία" "αθηννα"`,  // User's strict typo query
    `"gmail.com" ξενοδοχεία αθηννα`,     // Loose typo query
    `"gmail.com" "ξενοδοχεία" "αθήνα"`,   // Strict correct query
    `"gmail.com" ξενοδοχεία αθήνα`,      // Loose correct query
    `"gmail.com" ξενοδοχείο αθήνα`       // Loose singular correct query
  ];
