...
async function run() {
  const queries = [
    `site:facebook.com "gmail.com" ξενοδοχεία Καστοριά`,
    `site:instagram.com "gmail.com" ξενοδοχεία Καστοριά`,
    `"gmail.com" ξενοδοχεία Καστοριά`,
    `ξενοδοχεία Καστοριά gmail.com`
  ];
