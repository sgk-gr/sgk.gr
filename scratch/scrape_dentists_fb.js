...
const GREEK_CITIES = [
  "Αθήνα", "Θεσσαλονίκη", "Πάτρα", "Λάρισα", "Ηράκλειο", "Καστοριά", "Κοζάνη", 
  "Φλώρινα", "Γρεβενά", "Πτολεμαΐδα", "Βέροια", "Έδεσσα", "Νάουσα", "Κατερίνη", 
  "Ιωάννινα", "Βόλος", "Τρίκαλα", "Καρδίτσα", "Σέρρες", "Καβάλα", "Ξάνθη", 
  "Χανιά", "Ρόδος", "Χαλκίδα", "Καλαμάτα", "Αγρίνιο", "Λαμία", "Κέρκυρα"
];
...
async function scrapeDentistsFb() {
  const queries = [
    'site:facebook.com "gmail.com" "οδοντίατρος"',
    'site:facebook.com "yahoo.gr" "οδοντίατρος"',
    'site:facebook.com "hotmail.com" "οδοντίατρος"',
    'site:facebook.com "gmail.com" "οδοντιατρείο"',
    'site:facebook.com "yahoo.gr" "οδοντιατρείο"',
    'site:instagram.com "gmail.com" "οδοντίατρος"',
    'site:instagram.com "gmail.com" "οδοντιατρείο"',
    'site:facebook.com "gmail.com" "dentist" greece',
    'site:facebook.com "gmail.com" "dental clinic" greece'
  ];
  
  console.log(`\n==================================================`);
  console.log(`Starting Nationwide Facebook/Instagram Dentists Scraper`);
  console.log(`==================================================`);
  ...
  for (let i = 0; i < queries.length; i++) {
    ...
    console.log(`\n[Query ${i + 1}/${queries.length}] Searching: ${query}...`);
    ...
    try {
      ...
      for (const res of results) {
        ...
        for (const email of emails) {
          ...
          const detectedCity = extractCityFromText(combinedText);
          const rawName = cleanBusinessName(res.title, detectedCity, res.link);
          const finalName = rawName.length > 2 ? rawName : `Οδοντιατρείο - ${detectedCity}`;
    ...
    // Sleep 2 seconds to avoid rate limits
    await new Promise(r => setTimeout(r, 2000));
  }
  
  const finalLeads = Array.from(allProspectsMap.values());
  console.log(`\n==================================================`);
  console.log(`Facebook Scrape completed. Total unique leads: ${finalLeads.length}`);
  console.log(`==================================================`);
  ...
  console.log(`Saved ${savedCount} new dentists from Facebook/Instagram to database.`);
}
