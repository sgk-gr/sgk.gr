        ...
        <div className="container mx-auto px-6 max-w-4xl bg-white border border-gray-250 p-8 md:p-12 shadow-lg rounded-xl mt-8">
          ...
          <div className="space-y-8 text-gray-700 leading-relaxed text-[15px]">
            <section>
              ...
              <p>
                Στην SGK Software Development, σεβόμαστε την ιδιωτικότητά σας και δεσμευόμαστε για την προστασία των προσωπικών σας δεδομένων. Η παρούσα πολιτική περιγράφει πώς συλλέγουμε και χρησιμοποιούμε τα δεδομέναμ σας.
              </p>
            </section>
