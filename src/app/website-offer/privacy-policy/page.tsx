...
export const metadata: Metadata = {
  title: "Πολιτική Απορρήτου | SGK Website Offer",
  description: "Πολιτική Απορρήτου για την προσφορά κατασκευής ιστοσελίδας της SGK Software Development.",
};

export default function WebsiteOfferPrivacy() {
  return (
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="space-y-6 text-vivid-on-surface-variant leading-relaxed font-body-lg">
              ...
              <section>
                  ...
                  <p>
                      Συλλέγουμε μόνο τα απαραίτητα στοιχεία που μας παρέχετε μέσω της φόρμας επικοινωνίας (όπως email) με σκοπό την εξυπηρέτησή σας.
                  </p>
              </section>
