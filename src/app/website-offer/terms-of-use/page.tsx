...
export const metadata: Metadata = {
  title: "Όροι Χρήσης | SGK Website Offer",
  description: "Όροι Χρήσης για την προσφορά κατασκευής ιστοσελίδας της SGK Software Development.",
};

export default function WebsiteOfferTerms() {
  return (
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="space-y-6 text-vivid-on-surface-variant leading-relaxed font-body-lg">
              ...
              <section>
                  ...
                  <p>
                      Παρέχουμε υπηρεσίες ανάπτυξης λογισμικού, AI λύσεων και κατασκευής ιστοσελίδων. Καταβάλλουμε κάθε δυνατή προσπάθεια για την ακρίβεια των πληροφοριών και την ασφάλεια των συστημάτων μας.
                  </p>
              </section>
      ...
      <footer className="bg-vivid-surface-container-low full-width border-t border-vivid-surface-variant/20 mt-auto">
        <div className="flex flex-col md:flex-row justify-between items-center w-full px-gutter py-stack-lg max-w-container-max mx-auto gap-8">
          ...
          <div className="flex gap-4">
            <Link href="/website-offer/privacy-policy" className="font-body-md text-body-md text-vivid-on-tertiary-fixed-variant hover:text-vivid-primary transition-all underline underline-offset-4 uppercase">ΠΟΛΙΤΙΚΗ ΑΠΟΡΡΗΤΟΥ</Link>
            <Link href="/website-offer/terms-of-use" className="font-body-md text-body-md text-vivid-on-tertiary-fixed-variant hover:text-vivid-primary transition-all underline underline-offset-4 uppercase">ΟΡΟΙ ΧΡΗΣΗΣ</Link>
          </div>
