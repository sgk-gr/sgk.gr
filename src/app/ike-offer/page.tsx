...
export const metadata: Metadata = {
  ...
  description: "Επαγγελματική κατασκευή ιστοσελίδας για την ΙΚΕ σας εντός 24 ωρών, πλήρως συμβατή με τις απαιτήσεις του ΓΕΜΗ (Άρθρο 47 §2 Ν.4072/2012, ΚΥΑ 46982/2025). Κόστος μόνο 124€ συμπεριλαμβανομένου ΦΠΑ.",
  alternates: {
