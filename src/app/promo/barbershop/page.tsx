            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              ...
              <div className="pt-2">
                ...
                <label className="flex items-start gap-2 text-xs text-white/80 cursor-pointer group">
                  ...
                  <span>Αποδέχομαι τους <a href="/terms" target="_blank" rel="noopener noreferrer" className="underline hover:text-white">όρους χρήσης</a>.</span>
                </label>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="flex flex-col items-center md:items-start gap-2">
            ...
            <div className="mt-4 flex gap-4">
              <a href="/privacy" target="_blank" rel="noopener noreferrer" className="text-xs text-[#facc15] hover:text-yellow-300 transition-colors">Πολιτική Απορρήτου</a>
              <a href="/terms" target="_blank" rel="noopener noreferrer" className="text-xs text-[#4ade80] hover:text-green-300 transition-colors">Όροι Χρήσης</a>
            </div>
          </div>
        </div>
