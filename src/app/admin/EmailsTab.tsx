...
<p>Αφαιρέστε αυτή την εκκρεμότητα από τη λίστα σας σήμερα. Απαντήστε σε αυτό το email ή καλέστε μας στο <strong>6999524389</strong> και θα αναλάβουμε τα υπόλοιπα.</p>`,
    defaultButtonText: "Επικοινωνήστε Μαζί Μας",
    defaultButtonLink: "mailto:info@sgk.gr?subject=Ενδιαφέρον για Ιστοσελίδα ΙΚΕ"
  },
  {
