...
import { ArrowLeft, Bot, ShoppingCart, BarChart3, Mail, Sparkles, Package, Receipt, Users, TrendingUp, Share2, FileText, Eye, Zap, Globe, Search, Brain, Mic, Upload, MousePointer, Lightbulb, ListChecks, Gauge } from "lucide-react";
                ...
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-2 gap-12 items-start max-w-5xl">
                        <motion.div {...fadeUp}>
                            ...
                            <p className="text-muted-foreground leading-relaxed mb-6 text-white text-lg">
            ...
            <section className="py-20 bg-secondary/30">
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        {dashboardWidgets.map((w, i) => (
                            ...
                            >
                                ...
                                <h4 className="font-heading font-semibold text-sm mb-1 text-white">{w.title}</h4>
                    ...
                    >
                        ...
                        <div>
                            <h4 className="font-heading font-semibold text-sm mb-1 text-white">Integrations</h4>
                ...
                <div className="container mx-auto px-6 max-w-4xl">
                    ...
                    >
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h4 className="font-heading font-semibold mb-1 text-white">Extra Report Feature</h4>
                    ...
                    <div className="grid sm:grid-cols-3 gap-5">
                        {[
                            ...
                            >
                                ...
                                <h4 className="font-heading font-semibold text-sm mb-2 text-white">{item.title}</h4>
...
export default SigmalabsClient;
