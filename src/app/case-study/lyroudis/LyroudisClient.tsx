...
const systemModules = [
    {
        ...
        description: "Σχεδιασμός βάσει του Άρθρου 47 Ν. 4072/2012 & Ν. 4919/2022 για υποχρεωτική εταιρική δημοσιότητα ΙΚΕ στο διαδίκτυο.",
    },
    {
        icon: FileText,
            ...
            <section className="py-16 sm:py-20">
                <div className="container mx-auto px-6 max-w-5xl">
                    <motion.div {...fadeUp} className="mb-10 text-center">
                        <p className="text-primary font-heading text-sm tracking-[0.3em] uppercase mb-3">
                            Νομική Δημοσιότητα Ι.Κ.Ε. (Άρθρο 47 Ν. 4072/2012)
                        </p>
                ...
                <div className="container mx-auto px-6 max-w-3xl text-center">
                    <motion.div {...fadeUp}>
                        ...
                        <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                            Αποκτήστε την επίσημη ιστοσελίδα της ΙΚΕ σας με πλήρη νομική συμμόρφωση ΓΕΜΗ (Ν. 4072/2012) αυθημερόν.
                        </p>
