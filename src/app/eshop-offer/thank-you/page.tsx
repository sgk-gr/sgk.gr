          ...
          <div className="max-w-2xl w-full">
            ...
            <div className="bg-white border border-gray-250 p-8 rounded-xl shadow-md text-center mb-10">
              ...
              <p className="text-lg md:text-xl font-bold leading-relaxed text-black">
                Δώρο για εσάς: δωρεάν 1 χρόνο hosting αξίας €150 με την ολοκλήρωση της κατασκευής σας.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Link 
                href="/eshop-demo" 
                className="inline-flex items-center justify-center bg-[#4ade80] hover:bg-[#22c55e] text-black font-bold py-3 px-8 rounded-lg transition-all duration-300 text-base shadow-sm w-full sm:w-auto text-center"
              >
                Δείτε το live demo
              </Link>
              <Link 
                href="/" 
                className="inline-flex items-center justify-center bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-medium py-3 px-8 rounded-lg transition-all duration-300 text-base shadow-sm w-full sm:w-auto text-center"
              >
