...
export const metadata: Metadata = {
    ...
    description: "Ξεκινήστε το Eshop σας με προκαταβολή 600€ και το υπόλοιπο με 1.5% προμήθεια επί των πωλήσεων για 1 έτος. Μάθετε περισσότερα.",
    alternates: {
        canonical: "https://sgk.gr/pay-as-you-grow",
    },
    openGraph: {
        title: "SGK Pay as you grow | Κατασκευή Eshop με Ποσοστό",
        description: "Ξεκινήστε το Eshop σας με προκαταβολή 600€ και το υπόλοιπο με 1.5% προμήθεια επί των πωλήσεων για 1 έτος.",
