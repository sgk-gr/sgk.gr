        ...
        <div className="flex flex-col md:flex-row relative items-center gap-10 md:gap-16 lg:gap-24">
          ...
          >
            ...
            <p className="text-white/80 text-sm leading-relaxed">
              Αλλά δεν μένουμε στα απαραίτητα. Είμαστε σε διαρκή αναζήτηση νέων <span className="text-white font-medium">τεχνολογιών και συστημάτων</span> για να διαθέτουμε πάντα το ασφαλέστερο σύστημα προστασίας. Και μέσα από τη δική μας τεχνογνωσία, θέλουμε να σε εκπαιδεύσουμε ώστε να προστατεύεσαι κι εσύ από τους κινδύνους.
            </p>
          </motion.div>
