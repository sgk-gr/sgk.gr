                            ...
                            {[
                                {
                                    ...
                                    a: "Το Setup Fee είναι ακριβώς 250€. Αυτό το ποσό καλύπτει τα πραγματικά κόστη υποδομής για να ξεκινήσετε (server, domain, ssl κλπ). Δεν υπάρχουν κρυφές χρεώσεις, ούτε τώρα, ούτε ποτέ."
                                },
                                {
                                ...
                                {
                                    q: "Μπορώ να σταματήσω τη συνεργασία νωρίτερα και να εξαγοράσω το Eshop;",
                                    a: "Απολύτως, όποτε θέλετε χωρίς καμία δέσμευση ή έξτρα χρέωση! Αν το Eshop κοστίζει π.χ. 2.800€, εσείς πληρώνετε 250€ setup και 5% προμήθεια επί των πωλήσεων. Αν τον επόμενο μήνα έχετε 0 πωλήσεις, πληρώνετε 0€. Αν όμως έχετε πολλές πωλήσεις και δεν θέλετε πλέον να δίνετε το 5%, μπορείτε να εξοφλήσετε το υπόλοιπο (δηλαδή τα 2.800€ μείον το setup και τις προμήθειες που έχετε ήδη πληρώσει) οποιαδήποτε στιγμή και το Eshop γίνεται 100% δικό σας, χωρίς καμία επιπλέον χρέωση."
                                },
                                {
