...
const slides = [
  {
    ...
    description: "Ολοκληρωμένη εταιρική ιστοσελίδα για τη νέα σας Ι.Κ.Ε. με 100% συμμόρφωση στις προδιαγραφές ΓΕΜΗ. Περιλαμβάνει .gr domain για 2 έτη, ταχύτατο hosting, εταιρικό email, SSL και δημοσίευση ισολογισμών μόνο με 124€.",
    buttonText: "Δες την προσφορά (124€)",
