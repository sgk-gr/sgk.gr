...
const teamSchema = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "jobTitle": "Marketing & AI Strategist / E-commerce Specialist",
      "worksFor": {
        "@type": "Organization",
        "name": "SGK Software Development",
        "url": "https://sgk.gr"
        ...
        <div className="max-w-6xl mx-auto space-y-10">
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <motion.div
              ...
              className="flex flex-col items-center text-center gap-8 bg-card border border-border rounded-3xl p-8 lg:p-12 shadow-xl hover:shadow-primary/5 transition-all"
            >
          ...
          <motion.div
            ...
            className="flex flex-col md:flex-row items-center gap-10 bg-card border border-border rounded-3xl p-8 lg:p-12 shadow-xl hover:shadow-primary/5 transition-all max-w-4xl mx-auto"
          >
            <div className="w-36 h-36 sm:w-44 sm:h-44 shrink-0 relative rounded-full overflow-hidden border-4 border-primary/20 bg-background">
              <Image 
                src="/giakoumaki.png" 
            ...
            <div className="flex-1 text-center md:text-left">
              <h3 className="text-2xl font-heading font-bold mb-2">Βασιλική Γιακουμάκη</h3>
              <p className="text-primary font-semibold mb-6">Marketing & AI Strategist / E-commerce Specialist</p>
              
              <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
                <p>
                  Η Βασιλική συνδυάζει τη στρατηγική σκέψη του digital marketing με τις πιο σύγχρονες τεχνολογίες τεχνητής νοημοσύνης (AI) για να οδηγεί την ανάπτυξη των ηλεκτρονικών επιχειρήσεων. Με βαθιά εξειδίκευση σε Google Ads, Social Media, SEO και τεχνικές πωλήσεων, σχεδιάζει campaigns που φέρνουν μετρήσιμα αποτελέσματα.
                </p>
                <p>
                  Παράλληλα, διαθέτει την τεχνική κατάρτιση για να διαχειρίζεται κρίσιμα κομμάτια των web υποδομών (web hosting, domain management, website migrations) και να επιλύει σύνθετα τεχνικά ζητήματα, διασφαλίζοντας την απρόσκοπτη λειτουργία κάθε eshop.
                </p>
              </div>
            </div>
          </motion.div>
