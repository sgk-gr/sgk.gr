...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    title: "Υποχρεωτική Ιστοσελίδα Ι.Κ.Ε. βάσει Νόμου 4072/2012: Όλα όσα πρέπει να γνωρίζετε",
    excerpt: "Κάθε νέα Ι.Κ.Ε. υποχρεούται να αποκτήσει τη δική της εταιρική ιστοσελίδα εντός 30 ημερών. Μάθετε τις νομικές απαιτήσεις του ΓΕΜΗ και πώς να συμμορφωθείτε άμεσα.",
    ...
    content: `
      <h2>Η Νομοθεσία για την Ιστοσελίδα Ι.Κ.Ε. (Νόμος 4072/2012)</h2>
      ...
      <p>Σύμφωνα με το <strong>άρθρο 50 του Νόμου 4072/2012</strong>, κάθε Ι.Κ.Ε. οφείλει να διαθέτει δικό της δικτυακό τόπο (website) εντός <strong>30 ημερών</strong> από τη σύσταση της και την καταχώρισή της στο ΓΕΜΗ.</p>

      <h3>Ποιες είναι οι προδιαγραφές και τα υποχρεωτικά στοιχεία;</h3>
      <p>Η ιστοσελίδα μιας Ι.Κ.Ε. δεν είναι απλώς μια διαφημιστική σελίδα. Πρέπει να λειτουργεί ως επίσημος εταιρικός πίνακας ανακοινώσεων και να περιλαμβάνει υποχρεωτικά τα εξής στοιχεία:</p>
      <ul>
      ...
      <p>Η παράλειψη δημιουργίας ιστοσελίδας ή η ελλιπής αναγραφή των παραπάνω στοιχείων επισύρει <strong>διοικητικά πρόστιμα</strong> από τις αρμόδιες υπηρεσίες ελέγχου. Επιπλέον, μπορεί να δημιουργήσει προβλήματα κατά τη δημοσίευση των ετήσιων οικονομικών καταστάσεων ή σε μελλοντικές τροποποιήσεις του καταστατικού στο ΓΕΜΗ.</p>

      <h3>Η Λύση της SGK Digital σε 24 Ώρες με 124€</h3>
      ...
      <ul>
        ...
        <li><strong>Ολοκληρωμένο Πακέτο:</strong> Περιλαμβάνει κατοχύρωση Domain name (.gr) για 2 έτη, ασφαλή φιλοξενία (hosting) για 1 έτος και πιστοποιητικό ασφαλείας SSL.</li>
