...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    metaDescription: "Οδηγός για την υποχρεωτική ιστοσελίδα Ι.Κ.Ε. βάσει του Άρθρου 47 §2 του Ν.4072/2012, όπως εξειδικεύτηκε με την ΚΥΑ 46982/2025. Προδιαγραφές ΓΕΜΗ, προθεσμίες και πώς η SGK Digital την κατασκευάζει σε 24h με 124€.",
    content: `
