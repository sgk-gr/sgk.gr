...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    metaDescription: "Η SGK Digital παρουσιάζει το Pay As You Grow. Μηδενικό ρίσκο, 600€ Setup Fee και 5% προμήθεια μόνο όταν πουλάς. Το e-shop γίνεται 100% δικό σου σε 12 μήνες.",
    content: `
      ...
      <ul>
        <li><strong>Αρχικό Setup Fee:</strong> Μόνο 600€ (εφάπαξ). Το ποσό αυτό καλύπτει τα βασικά λειτουργικά έξοδα (Server 1 έτους, Domain .gr 2 ετών, SSL) και το setup.</li>
