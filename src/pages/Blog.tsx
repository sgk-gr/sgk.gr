...
const Blog = () => {
    return (
        <div className="min-h-screen bg-background text-foreground selection:bg-primary/30">
            <Helmet>
                <title>Blog & Insights | SGK Digital Software Development</title>
                <meta name="description" content="Διαβάστε τα τελευταία νέα για AI αυτοματισμούς, κατασκευή eshop νέας γενιάς και ψηφιακό μετασχηματισμό από την ομάδα της SGK Digital." />
            </Helmet>
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="max-w-3xl mb-16">
                        ...
                        >
                            ...
                            <h1 className="text-5xl md:text-7xl font-heading font-bold leading-tight mb-6">
                                Το Blog της <span className="text-gradient">SGK Digital</span>
                            </h1>
                    ...
                    <div className="grid md:grid-cols-2 gap-10">
                        {BLOG_POSTS.map((post, index) => (
                            ...
                            >
                                <Link to={`/blog/${post.slug}`} className="block overflow-hidden rounded-2xl mb-6 relative aspect-[16/9]">
                                    <img
                                        src={post.image}
                                        alt={post.title}
