                    ...
                    >
                        ...
                        <div className="prose prose-invert prose-primary max-w-none space-y-6 text-muted-foreground leading-relaxed">
                            <section>
                                ...
                                <p>
                                    Χρησιμοποιώντας την ιστοσελίδα της SGK Digital, αποδέχεστε πλήρως τους παρόντες όρους χρήσης. Εάν δεν συμφωνείτε, παρακαλούμε να μην χρησιμοποιείτε την υπηρεσία.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <p>
                                    Όλο το περιεχόμενο της ιστοσελίδας, συμπεριλαμβανομένων των κειμένων, γραφικών και κώδικα, αποτελεί πνευματική ιδιοκτησία της SGK Digital εκτός αν αναφέρεται διαφορετικά.
                                </p>
                            </section>
