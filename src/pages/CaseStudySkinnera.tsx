...
const CaseStudySkinnera = () => {
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Skinnera IKE Case Study | Mobile App Διαχείρισης Συνεργατών — SGK Digital</title>
        <meta name="description" content="Case study: Πλατφόρμα διαχείρισης συνεργατών με Flutter mobile app, Firebase, push notifications, σύστημα επιβράβευσης και tracking ΕΣΠΑ/ΔΥΠΑ αιτήσεων." />
        <meta name="keywords" content="flutter app, mobile app, διαχείριση συνεργατών, ΕΣΠΑ, ΔΥΠΑ, push notifications, firebase, android app, partner management, rewards system" />
        <link rel="canonical" href="https://sgk.gr/case-study/skinnera" />
        <meta property="og:title" content="Skinnera IKE — Partner Management App | SGK Digital" />
        <meta property="og:description" content="Flutter mobile app για διαχείριση συνεργατών, push notifications και tracking ΕΣΠΑ/ΔΥΠΑ." />
        <meta property="og:url" content="https://sgk.gr/case-study/skinnera" />
      </Helmet>
      {/* Navigation */}
...
export default CaseStudySkinnera;
