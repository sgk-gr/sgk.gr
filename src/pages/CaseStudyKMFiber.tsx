...
const CaseStudyKMFiber = () => {
    return (
        <div className="min-h-screen bg-background">
            <Helmet>
                <title>KM-FIBER Case Study | Σύστημα Διαχείρισης Οπτικών Ινών — SGK Digital</title>
                <meta name="description" content="Case study: Ολοκληρωμένη πλατφόρμα διαχείρισης οπτικών ινών για partner Cosmote/Vodafone. Καταχώρηση πελατών, live tracking συνεργείων, AI αυτοψίες, real-time βλάβες. React, Supabase, Google Maps API." />
                <meta name="keywords" content="σύστημα διαχείρισης οπτικών ινών, fiber optics management, cosmote, vodafone, live tracking, ai vision, real-time βλάβες, crew management, telecom operations platform" />
                <link rel="canonical" href="https://sgk.gr/case-study/km-fiber" />
                <meta property="og:title" content="KM-FIBER — Τelecom Operations Platform | SGK Digital" />
                <meta property="og:description" content="Ολοκληρωμένο σύστημα οπτικών ινών: live tracking, AI αυτοψίες, real-time βλάβες, Google Maps, Cosmote/Vodafone." />
                <meta property="og:url" content="https://sgk.gr/case-study/km-fiber" />
            </Helmet>
            {/* Navigation */}
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
                        {results.map((r, i) => (
                            ...
                            >
                                ...
                                <p className="text-2xl sm:text-3xl font-heading font-bold text-gradient mb-1">{r.value}</p>
...
export default CaseStudyKMFiber;
