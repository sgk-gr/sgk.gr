                ...
                <div style="background-color: #ffffff; padding: 30px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.03);">
                    ...
                    <div style="text-align: center; margin-top: 30px; border-top: 1px solid #f2e3db; padding-top: 20px;">
                        ...
                        <div style="margin-bottom: 15px;">
                            ...
                            <a href="viber://add?number=306999524389" style="display: inline-block; background-color: #7360F2; color: #ffffff; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: bold; font-size: 15px; margin: 5px; box-shadow: 0 4px 10px rgba(115, 96, 242, 0.2);">💜 Viber Message</a>
                        </div>
